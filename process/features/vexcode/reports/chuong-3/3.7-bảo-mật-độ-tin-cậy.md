...
Trước khi đọc, ghi, hoặc spawn process, hệ thống kiểm tra đường dẫn qua ***isPathSafe(targetPath, baseDir)*** (***fileService.js:14***).
...
| Đầu vào | Ràng buộc |
|---------|-----------|
| `target_path` | ***isPathSafe*** + ***getProjectName*** replace invalid chars |
| Request body | ***express.json({ limit: '100kb' })*** chống bomb payload |
| Rule config keys | Whitelist ***knownKeys*** trong ***writeEnvConfig***: chỉ ghi các key đã biết |
