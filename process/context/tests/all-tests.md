...
- use `process/context/tests/browser-automation.md` for browser-level automation details.

## Quick Decision Guide

(No test runners have been configured yet since the backend technology stack is pending definition. Automated unit, integration, and UI testing setups will be configured and documented here once implementation begins.)
...
| `packages/cli` | Manual | `npm link` / `vexcode --version` | Test global linking & binary registry |

## Debugging Quick Reference

- **No test setup yet:** Currently, the project is in the initial design and harness-setup phase. No active runners or test suites exist.

## Known Gaps

- No test suites or test runner configs are present yet.
