...
This project is indexed by GitNexus as **vexcode** (2946 symbols, 4760 relationships, 121 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
