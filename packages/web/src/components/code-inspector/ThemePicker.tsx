  ...
  return (
    <div className="flex items-center gap-1.5">
      ...
      <select
        ...
        className="appearance-none bg-bg-tertiary/50 border border-card-border/30 rounded-md px-2 py-0.5 pr-5 text-[10px] font-semibold text-text-secondary uppercase tracking-wider cursor-pointer hover:bg-bg-tertiary hover:text-text-primary transition-colors focus:outline-none focus:border-accent/50"
        style={{
          backgroundImage:
