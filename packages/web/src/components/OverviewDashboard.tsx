      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="p-5 rounded-xl border border-card-border bg-card-bg backdrop-blur-md flex flex-col justify-start">
          ...
          <div className="space-y-4">
            {[
              { id: 'security', name: 'Security & Secrets', icon: '🛡️', count: stats.security },
              { id: 'quality', name: 'Code Quality & Reliability', icon: '⚙️', count: stats.quality },
              { id: 'architecture', name: 'AST & Call Flow', icon: '📊', count: stats.architecture },
              { id: 'maintainability', name: 'Style & Maintainability', icon: '💡', count: stats.maintainability }
            ].map(cat => {
              ...
              return (
                <div key={cat.id} className="text-xs">
                  <div className="flex justify-between text-text-secondary mb-1">
                    <span className="font-semibold text-text-primary">{cat.icon} {cat.name}</span>
